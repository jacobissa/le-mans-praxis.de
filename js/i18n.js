...
function fixDirection(new_lang_code) {
  if (new_lang_code === "ar") {
    $("#my-content-home .contact-start, #my-content-home .contact-end").removeClass("pe-sm-2 ps-sm-2");
    $("#my-content-home .contact-start").addClass("ps-sm-2");
    $("#my-content-home .contact-end").addClass("pe-sm-2");
    ...
    $("#my-content-home .contact-start, #my-content-home .contact-end").removeClass("pe-sm-2 ps-sm-2");
    $("#my-content-home .contact-start").addClass("pe-sm-2");
    $("#my-content-home .contact-end").addClass("ps-sm-2");
